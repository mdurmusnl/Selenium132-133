...
import com.myfirstproject.myfirstproject.utilities.LoggerUtils;
...
//    GOAL: Use Reusable Methods only.
    ...
    public void registerUserTest() throws IOException {
        ...
        extentTest.pass("navigating the sign up page").addScreenCaptureFromPath(takeScreenshotOfTheEntirePageAsString());
...
//        clickWithTimeOut( driver.findElement(By.partialLinkText("Signup / Login")) , 6 );//WORKS BUT NOT EXCELLENT
        //the below is method in method -->(By.partialLinkText("Signup / Login"),3)=it explicitly locates
...
//        driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("fasdffa@gmail.com");
//        driver.findElement(By.xpath("//button[@data-qa='signup-button']")).click();
        sendKeysWithTimeout(waitForVisibility(By.name("name"), 3), "John Wick", 6);
        sendKeysWithTimeout(waitForVisibility(By.xpath("//input[@data-qa='signup-email']"), 3), "fas2dffa@gmail.com", 6);
        clickWithTimeOut(waitForVisibility(By.xpath("//button[@data-qa='signup-button']"), 3), 6);

        extentTest.pass("Adding  user informations...").addScreenCaptureFromPath(takeScreenshotOfTheEntirePageAsString());
