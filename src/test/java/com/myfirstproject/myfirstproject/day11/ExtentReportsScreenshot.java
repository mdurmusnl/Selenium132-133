...
public class ExtentReportsScreenshot extends TestBase {
    /*
...
//        When user type “uni” in the search box
        extentTest.pass("Taking the screenshot of the home page").
                ...
                assignCategory("Smoke","Regression","Integression").
                assignAuthor("Andrey","Fierro").
                addScreenCaptureFromPath(takeScreenshotOfTheEntirePageAsString());  //takeScreenshotOfTheEntirePageAsString()returns a path as String
        //TAKE SCREENSHOT
